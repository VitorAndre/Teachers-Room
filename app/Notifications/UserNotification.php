...
class UserNotification extends Notification
{
    ...
    {  
        ...
        return (new MailMessage)
			...
			->subject('Há novas requisições de usuários')
			->greeting('Olá, tudo bem?')
			->line('Você está recebendo esse e-mail para checar novas requisições de usuários, por favor acesse o link abaixo:')
			->action('Novas requisições de usuarios', url('/requisicao_usuarios'))
